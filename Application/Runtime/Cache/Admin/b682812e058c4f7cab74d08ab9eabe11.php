...
<div id="dcMain">
    <!-- 当前位置 -->
    <div id="urHere">系统管理中心<b>></b><strong><?php echo ($Menu); ?>列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>
        <a href="<?php echo U('add');?>" class="actionBtn add">添加<?php echo ($Menu); ?></a>
        <?php echo ($Menu); ?>列表
    </h3>
    <div class="filter">
        ...
        <form id="MyForm" method="post">
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                <tr>
                    ...
                    <th align="left"><?php echo ($Menu); ?>名称</th>
                ...
                <?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    <td align="center">
                        <input type="checkbox" name="DelID[]" value="<?php echo ($val["AdminID"]); ?>" />
                    </td>
                    <td align="center"><?php echo ($val["AdminID"]); ?></td>
                    <td align="center"><input type="text" name="Sort[<?php echo ($val["AdminID"]); ?>]" value="<?php echo ($val["AdminSort"]); ?>" class="inpMain" size="3"></td>
                    <td align="left"><?php echo ($val["AdminName"]); ?></td>
                    <td align="center">
                        <?php if($val['AdminState'] == 1): ?>以启用
                        <?php else: ?>
                            未启用<?php endif; ?>
                    </td>
                    <td align="center">
                        <a href="<?php echo U('edit',array('id'=>$val['AdminID']));?>">编辑</a> |
                        <a href="<?php echo U('del',array('id'=>$val['AdminID']));?>">删除</a>
                    </td>
    ...
    <div class="clear"></div>
    <div class="pager">
        总计 <?php echo ($count); ?> 个记录，共 <?php echo ($totalPages); ?> 页，当前第 <?php echo ($CurrentPage); ?> 页 |
        <?php echo ($page); ?>
    </div>
