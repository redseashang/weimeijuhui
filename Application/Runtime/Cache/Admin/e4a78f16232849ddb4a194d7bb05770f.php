...
<div id="dcMain">
    ...
    <h3><a href="<?php echo U('index');?>" class="actionBtn">栏目列表</a>添加栏目</h3>
    <form action="<?php echo U('addsave');?>" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" size="80" class="inpMain" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="type" value="<?php echo ($ModelName); ?>" size="80" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td width="90" align="right">约束条件</td>
                <td>
                    <input type="text" name="condition" size="80" class="inpMain" />
                    注：无特殊需求请不要对其设置
                </td>
            </tr>
            <tr>
